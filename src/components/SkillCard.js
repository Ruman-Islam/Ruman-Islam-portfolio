...
const SkillCard = ({ language, img, features }) => {
    return (
        <div className="pattern-dots-md gray-light hover:transform hover:scale-105 duration-500 cursor-pointer skillCard">
            <div className="rounded p-4 w-64 h-64 2xl:h-80 2xl:w-80">
