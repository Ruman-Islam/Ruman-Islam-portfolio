            ...
            <div
                ...
                <div>
                    ...
                    <div className='text-[14px] 2xl:text-[16px] flex justify-between'>
                        <span className={`px-5 ${pathname.includes('/projects') ? 'md:px-10 2xl:px-14' : 'md:px-8'} py-1 rounded text-white bg-[#29303D]`}>HTML</span>
                        <span className={`px-5 ${pathname.includes('/projects') ? 'md:px-10 2xl:px-14' : 'md:px-8'} py-1 rounded text-white bg-[#29303D]`}>CSS</span>
                        <span className={`px-5 ${pathname.includes('/projects') ? 'md:px-10 2xl:px-14' : 'md:px-8'} py-1 rounded text-white bg-[#29303D]`}>JS</span>
                        <span className={`px-5 ${pathname.includes('/projects') ? 'md:px-10 2xl:px-14' : 'md:px-8'} py-1 rounded text-white bg-[#29303D]`}>MERN</span>
                    </div>
