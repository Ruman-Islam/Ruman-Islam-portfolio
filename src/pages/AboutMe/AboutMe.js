            ...
            <div className="resume-description light-border-bottom">
              <div>
                <p className="no-underline">
                  I'm a Front-End web developer. My passion is to involve in the
                  programming world for a lifetime. I really enjoy building web
                  applications and adding new features. Patience is one of my
                  god's blessings for me. This is my key power in solving
                  problems in programming. Furthermore, as I am really
                  ambitious, I can, and want to work with the organizational
                  team and will be through every thick and thin. Lastly, I find
                  this sector very spellbinding and will always work with my
                  full enthusiasm.
                </p>
              </div>
            </div>
